 ...
 * @author Hikeru
 */
public class SetHealth implements IFunction {
    ...
    public void execute(ConfigurableCommand command, Plugin plugin, CommandSender sender, String[] args) {
        if (args.length == 2) {
            ...
            //set radius
            AreaManager.getFortressByName(args[0]).setHealth(Integer.parseInt(args[1]) * 3);
            WDmsg.nice(sender, args[0] + WDmsg.nice + "'s health is now &e" + args[1]);
